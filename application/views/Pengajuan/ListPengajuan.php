						...
						foreach ($datakr as $row) {
							...
							<tr>
								...
								<?php }
									...
									<a href="<?= base_url('CPengajuan/ver/').$row->nomor_nasabah; ?>" class="btn btn-primary btn-xs">
									...
									<a href="<?= base_url('CPengajuan/vercancel/').$row->nomor_nasabah; ?>" class="btn btn-danger btn-xs" title="Cancel" >
